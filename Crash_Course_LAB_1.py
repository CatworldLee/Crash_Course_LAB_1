...
import os
path, dirs, files = next(os.walk("C:/Users/LiChengHao/Desktop/major/project/lab1-neural-networks-master/letters_mod/"))
files.sort()
...
for i in range(len(files)):
  img = cv2.imread("C:/Users/LiChengHao/Desktop/major/project/lab1-neural-networks-master/letters_mod/"+files[i],cv2.IMREAD_GRAYSCALE)
